...
function onOpen() {
  SpreadsheetApp.getUi()
    ...
    .addSeparator()
    .addItem("🤖 AI MOM Assistant", "openAIAssistant")
...
function getSystemValue(key) {
  const sheet =
    SpreadsheetApp.getActiveSpreadsheet().getSheetByName(SYSTEM_SHEET_NAME);
 ...
 */
function comingSoon() {
  SpreadsheetApp.getUi().alert("Module under development.");
}
